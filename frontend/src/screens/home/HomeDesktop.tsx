...
// -------------------------------------------------------------
// DECORATIVE BACKGROUND COMPONENTS (DESKTOP SCALE)
// -------------------------------------------------------------
...
// -------------------------------------------------------------
// FLOWER NODE ANIMATION WRAPPERS (DESKTOP SCALE)
// -------------------------------------------------------------
...
export const HomeDesktop: React.FC = () => {
  ...
  const screenWidth = Math.min(windowWidth - 240, 800); // Sidebar is wider on desktops
