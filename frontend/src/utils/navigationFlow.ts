...
export const navigateToActivity = async (
  ...
  if (normalizedType === 'video') {
    try {
      ...
      customAlert('Error', err instanceof Error ? err.message : 'Failed to load video');
    }
    ...
    try {
      ...
      customAlert('Error', err instanceof Error ? err.message : 'Failed to load audio');
    }
    ...
    try {
      ...
      customAlert('Error', err instanceof Error ? err.message : 'Failed to load speak activity');
    }
    ...
    try {
      ...
      customAlert('Error', err instanceof Error ? err.message : 'Failed to load write activity');
    }
    ...
    try {
      ...
      customAlert('Error', err instanceof Error ? err.message : 'Failed to load drag and drop activity');
    }
  }
};
